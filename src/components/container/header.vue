<template>
    <div class="header">
        <el-row :gutter="10">
           ...
           <el-col :xs="12" :sm="12" :md="{span:2,offset: 8}" >
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item >
                            <div class="setting-div">
                                <span class="setting-icon"><i class="iconfont  icon-kefuyouxian"></i></span> 
                                <span class="setting-string"> Profile  个人</span>
                            </div>
                        </el-dropdown-item>
                        <el-dropdown-item divided>
                            <div class="setting-div">
                                <span class="setting-icon"><i class="iconfont icon-shezhi"></i></span> 
                        ...
                        <el-dropdown-item divided>
                            <div class="setting-div">
                                <span class="setting-icon"><i class="iconfont icon-tuichu"></i></span> 
